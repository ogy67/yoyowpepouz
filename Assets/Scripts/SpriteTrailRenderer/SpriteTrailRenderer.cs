...
namespace SpriteTrailRender
{
    ...
    public class SpriteTrailRenderer : MonoBehaviour, IPoolable
    {
        ...
        private readonly static List<Color32> _rainbowColors = new List<Color32>
    {
        ...
        private GameObject parentTrail;
        ...
        private void Start()
        {
            ...
            if (parentTrail == null)
                parentTrail = new GameObject("contentTrailPool");
        }
        ...
        private void Update()
        {
            if (_spawnType == SpawnType.TIME && Time.time - _lastSpawnTime >= _timeBetweenTrailSpawn)
            {
                ...
                trailObject._parent = transform;

                trailObject.transform.SetParent(parentTrail.transform);
        ...
        private GameObject SpawnTrailObject()
        {
            ...
            if(parentTrail == null)
                parentTrail = new GameObject("contentTrailPool");
            newGameobject.transform.SetParent(parentTrail.transform);
        ...
        private void SetValues(SpriteTrailObject trailObject)
        {
            ...
            trailObject.transform.localScale = _startScale;
            trailObject.SetSpawnValues(_spriteRenderer, this, _rainbowMode ? _rainbowColors : _userSelectedColorPalette);
        }
