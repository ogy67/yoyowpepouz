...
public class infinisManager : MonoBehaviour
{
    ...
    * VARIABLES DE PARTIE
    */
    private static int nbPaternToBeReusable = 9;
    // difficulté
    private static int lvlDifficulty = 1;
    public static List<int> rangUpDifficulty = new List<int>() { 10, 25, 45, 70 }; // { 15, 30, 50, 70 }
    ...
    /*
     * void chooseNewPatern(int lvl)
     * void startInfinis()
     *  IEnumerator initGame()
     * void winLevel()
     *  IEnumerator nextLevel()
     * static void died()
     *  IEnumerator endInfinis()
     *  IEnumerator reactiveBtnChangeRot(bool newLevel)
     */
    ...
    private IEnumerator nextLevel()
    {
        ...
        yield return new WaitForSeconds(1.2f);// 1.5f
