...
public class itemSound : MonoBehaviour
{
    ...
    public void fadeMusicGameOver()
    {
        StartCoroutine(fadeMusicGameOver_loop());
    }
    private IEnumerator fadeMusicGameOver_loop()
    {
        float t = 0f;
        float goalVolume = player.volume * factorMinMusicGameOver;
        float diffVolume = player.volume - goalVolume;
