...
{
    [AddComponentMenu("UI/Scroll Rect Fast", 37)]
    [SelectionBase]
    [ExecuteAlways]
    ...
    /// </remarks>
    public class ScrollRectFast : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        /// <summary>
