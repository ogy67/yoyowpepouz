...
public class ScrollRectNested : ScrollRect
{
    ...
    //[SerializeField]
    public ScrollRectFast parentScrollRect;
    ...
    public override void OnBeginDrag(UnityEngine.EventSystems.PointerEventData eventData)
    {
        ...
        if (routeToParent)
        {
            if (parentScrollRect != null)
            {
                ...
                parentScrollRect.GetComponent<doubleScrollShop>().OnBeginDrag(eventData);
            }
        }
        else
        {
    ...
    public override void OnEndDrag(UnityEngine.EventSystems.PointerEventData eventData)
    {
        if (routeToParent)
        {
            if (parentScrollRect != null)
            {
                parentScrollRect.GetComponent<doubleScrollShop>().OnEndDrag(eventData);
