...
public class botInfoCard : MonoBehaviour
{
    ...
    public infoPlayerTest toInfoPlayer()
    {
        ...
        info.levelBoostUsed_record = itemBoostRecord1.getIdBoost() + "," + itemBoostRecord2.getIdBoost() + "," + itemBoostRecord3.getIdBoost();
    ...
    public void loadCardWithSavedInfo(string info)
    {
        ...
        itemBoostWeek1.loadBoostWithSavedInfo(tab[4]);
        itemBoostWeek2.loadBoostWithSavedInfo(tab[5]);
        itemBoostWeek3.loadBoostWithSavedInfo(tab[6]);
        itemBoostRecord1.loadBoostWithSavedInfo(tab[7]);
        itemBoostRecord2.loadBoostWithSavedInfo(tab[8]);
        itemBoostRecord3.loadBoostWithSavedInfo(tab[9]);
        myId = tab[10];
    }
