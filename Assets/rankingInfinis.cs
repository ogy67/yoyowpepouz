...
public class rankingInfinis : MonoBehaviour
{
    ...
    public void openMenuRankingInfinis(bool reloadRankings)
    {
        //menuWaitFillRankAnim.Play("waitInitConnec");
        onlineRankingManager.getInstance().loadAllDatas(reloadRankings);
        initialisation = true;
    }
    ...
    {
        if (!toWeek && notifRewardGo.activeSelf)
    ...
    public void resultGetRewardPrevWeek(bool gotTheReward)
    {
        if(gotTheReward)
