...
{
    /*public bool test_btnOpenRankInfinis = false;
    public bool test_btnCloseRankInfinis = false;
    // Update is called once per frame
    void Update()
    {
        if (test_btnOpenRankInfinis)
        {
            test_btnOpenRankInfinis = false;
            btnOpenRankingInfinis();
        }
        if (test_btnCloseRankInfinis)
        {
            test_btnCloseRankInfinis = false;
            btnCloseRankingInfinis();
        }
    }*/
    ...
    public void resultUpdatePlayerValuesInBdd(/*bool succedUpdating,*/ bool playerValuesChanged)
    {
        Debug.Log("5");
        //if (succedUpdating)
        //{
