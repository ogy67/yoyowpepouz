...
public class secretOffer : MonoBehaviour
{
    ...
    public int goalDownloadedApp = 50;
    public int goalNormal = 70;
    ...
    public void playerEndGame()
    {
        ...
        && !offerGivenThisSession)
        {
            ...
            if (launcher.getInstance().adIsLoaded(launcher.nameAd[typeAd.special_offer_ad]))
            {
    ...
    public void btnGetOffer()
    {
        ...
        launcher.getInstance().UserChoseToWatchAd(typeAd.special_offer_ad);
