...
public class ScrollRectSnap_CS : MonoBehaviour
{
    ...
    public static int maxNumLevel = 77;
    ...
    */
    ...
    private Transform levelMax_limit; // peut pas aller au dessus de level lock
    ...
    private void LateUpdate()
    {
        ...
        if(currentSpeedScrollPan <= minSpeedScrollPanToSnap)
        {
            isSnapingItem = true;
        }
    ...
    private void Update()
    {
        ...
        for (int i = 0; i < lesItems.Length; i++)
        {
            distance[i] = Mathf.Abs(center.transform.position.x - lesItems[i].position.x);
    ...
    */
    ...
    private Transform currentLimit_toCompare;
    ...
    */
    ...
    private bool isAboveLimits()
    {
        ...
        {
            if (lockedOnLeft && level1_limit.position.x - center.position.x > 0)
            {
            ...
            else if (lockedOnRight && levelMax_limit.position.x - center.position.x < 0)
            {
